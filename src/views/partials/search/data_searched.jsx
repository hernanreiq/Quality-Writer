            ...
            <React.Fragment>
                <div className={this.state.classNameRow}>
                    ...
                    <div className="col-md-3 my-1 text-center">
                        <button onClick={this.deletePost} className="btn btn-dark m-1 py-2 text-danger"><i className="h4 mb-0 far fa-trash-alt"></i></button>
                        <button onClick={this.updatetPost} className="btn btn-dark m-1 py-2 text-info"><i className="h4 mb-0 fas fa-edit"></i></button>
                        <button onClick={this.readPost} className="btn btn-dark m-1 py-2 text-success"><i className="h4 mb-0 fas fa-eye"></i></button>
                    </div>
                </div>
            </React.Fragment>
        )
